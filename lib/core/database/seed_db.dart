  ...
  static Future<void> seedDatabase(Database db) async {
    ...
    final users = [
      ...
      },
      {
        ...
        'USE_BIRTHDATE': '1985-05-10',
        'USE_PHONE_NUMBER': 610000002,
        'USE_LICENCE_NUMBER': 100002,
        'USE_SEX': 'Homme',
        'USE_MEMBERSHIP_DATE': '2021-01-01',
      },
      {
        'USE_ID': 3,
        'ADD_ID': 3,
      ...
      },
      {
        ...
        'USE_NAME': 'Loane',
        'USE_LAST_NAME': 'Kante',
        'USE_BIRTHDATE': '2000-05-10',
        'USE_PHONE_NUMBER': 610000004,
        'USE_LICENCE_NUMBER': 100006,
        'USE_SEX': 'Femme',
        'USE_MEMBERSHIP_DATE': '2023-01-01',
      },
      {
        'USE_ID': 5,
        'ADD_ID': 3,
      ...
      },
      {
        ...
        'ADD_ID': 3,
        'CLU_ID': null,
        'USE_MAIL': 'grace.parker@example.com',
        'USE_PASSWORD': 'pwd123',
        'USE_NAME': 'Grace',
        'USE_LAST_NAME': 'Parker',
        'USE_BIRTHDATE': '1988-03-15',
        'USE_PHONE_NUMBER': 610000006,
        'USE_LICENCE_NUMBER': 100008,
        'USE_SEX': 'Femme',
        'USE_MEMBERSHIP_DATE': '2021-01-01',
      },
      {
      ...
      },
      {
        ...
        'ADD_ID': 7,
        'CLU_ID': null,
        'USE_MAIL': 'ino.casablanca@example.com',
        'USE_PASSWORD': 'pwd123',
        'USE_NAME': 'Ino',
        'USE_LAST_NAME': 'Casablanca',
        'USE_BIRTHDATE': '1991-11-20',
        'USE_PHONE_NUMBER': 620000007,
        'USE_LICENCE_NUMBER': 200004,
        'USE_SEX': 'Femme',
        'USE_MEMBERSHIP_DATE': '2023-01-01',
      },
      {
        ...
        'ADD_ID': 8,
        'CLU_ID': null,
        'USE_MAIL': 'cassiopee.guerdat@example.com',
        'USE_PASSWORD': 'pwd123',
        'USE_NAME': 'Cassiopée',
        'USE_LAST_NAME': 'Guerdat',
        'USE_BIRTHDATE': '1993-04-30',
        'USE_PHONE_NUMBER': 620000008,
        'USE_LICENCE_NUMBER': 200005,
        'USE_SEX': 'Femme',
        'USE_MEMBERSHIP_DATE': '2023-01-01',
      },
      {
        ...
        'USE_NAME': 'Chloe',
        'USE_LAST_NAME': 'Libre',
        'USE_BIRTHDATE': '1998-01-10',
        'USE_PHONE_NUMBER': 620000009,
        'USE_LICENCE_NUMBER': null,
        'USE_SEX': 'Femme',
        'USE_MEMBERSHIP_DATE': '2024-01-01',
      },
    ];
    ...
    // 9. Races (avec RAC_SEX et RAC_CHIP_REQUIRED et RAC_NAME)
    final races = [
      {
        'RAC_ID': 1,
        'RAC_NAME': 'Trail découverte',
        'USE_ID': 4,
        'RAI_ID': 1,
